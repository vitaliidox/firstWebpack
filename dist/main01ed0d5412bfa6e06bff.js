...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ CityCard; }\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar CityCard = function CityCard(parrent, data, place) {\n  _classCallCheck(this, CityCard);\n\n  parrent.innerHTML += \"\\n    <div class=\\\"card city-small bigDig blue lighten-2\\\">\\n        <div>\\n        <div class=\\\"card-content\\\">\\n            <h5>City: \".concat(place.name, \"</h5>\\n            <img src=\\\"http://openweathermap.org/img/wn/\").concat(data.weather[0].icon, \"@2x.png\\\" class = \\\"icon\\\"></img>\\n            <p>\").concat(data.weather[0].description[0].toUpperCase() + data.weather[0].description.substring(1), \"</p>\\n            <p>Temperature day: \").concat(data.temp.day, \"</p>\\n            <p>Temperature night: \").concat(data.temp.night, \"</p>\\n        </div>\\n        <div/>\\n      </div>\\n\");\n};\n\n\n\n//# sourceURL=webpack:///./CityCard.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ DailyWeatherCard; }\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar DailyWeatherCard = function DailyWeatherCard(parrent, dat) {\n  _classCallCheck(this, DailyWeatherCard);\n\n  for (var i = 0; i < 7; i++) {\n    var date = new Date((dat.daily[i].dt + dat.timezone_offset) * 1000);\n    var month = (date.getMonth() + 1).toString().length < 2 ? '0' + (date.getMonth() + 1).toString() : (date.getMonth() + 1).toString();\n    parrent.innerHTML += \"\\n    <div class=\\\"card blue lighten-2 dayD\\\">\\n        <div class=\\\"card-content white-text\\\">\\n        <span class=\\\"card-title\\\">\".concat(date.getDate(), \".\").concat(month, \"</span>\\n                <p id=\\\"dailyCity\\\">\").concat(dat.timezone.slice(dat.timezone.indexOf('/') + 1), \"</p>\\n                <img src = \\\"http://openweathermap.org/img/wn/\").concat(dat.daily[i].weather[0].icon, \"@2x.png\\\" class = \\\"icon\\\">\\n                <p>Daily temperature: \").concat(dat.daily[i].temp.day, \" </p>\\n                <p>Nightly temperatyre: \").concat(dat.daily[i].temp.night, \" </p>\\n                <p>Weather: \").concat(dat.daily[i].weather[0].main, \"</p>\\n                <p>Description: \").concat(dat.daily[i].weather[0].description, \"</p>\\n                <p>Wind speed: \").concat(dat.daily[i].wind_speed, \"</p>\\n        </div>        \\n    </div>\\n\");\n  }\n};\n\n\n\n//# sourceURL=webpack:///./DailyWeatherCard.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ HourlyWeatherCard; }\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar HourlyWeatherCard = function HourlyWeatherCard(parr, d, horlyNow, weatherArr) {\n  _classCallCheck(this, HourlyWeatherCard);\n\n  function degToCard(value) {\n    value = parseFloat(value);\n    if (value <= 11.25) return 'N';\n    value -= 11.25;\n    var allDirections = ['NNE', 'NE', 'ENE', 'E', 'ESE', 'SE', 'SSE', 'S', 'SSW', 'SW', 'WSW', 'W', 'WNW', 'NW', 'NNW', 'N'];\n    var dIndex = parseInt(value / 22.5);\n    return allDirections[dIndex] ? allDirections[dIndex] : 'N';\n  }\n\n  parr.innerHTML = \"\";\n\n  for (var i = 0; i < 5; i++) {\n    var time = new Date(d.list[i].dt_txt);\n    parr.innerHTML += \"\\n    <div class=\\\"card blue lighten-2\\\">\\n        <div class=\\\"card-content white-text\\\">\\n            <span class=\\\"card-title\\\">\".concat(d.city.name, \"</span>\\n                <p>Time: \").concat(time.getHours(), \":\").concat(time.getMinutes(), \"</p>\\n                <img src = \\\"http://openweathermap.org/img/wn/\").concat(d.list[i].weather[0].icon, \"@2x.png\\\" class = \\\"icon\\\">\\n                <p></p>\\n                <p>\").concat(d.list[i].weather[0].description[0].toUpperCase() + d.list[i].weather[0].description.substring(1), \"</p>\\n                <p>Temperature max: \").concat(d.list[i].main.temp_max, \"</p>\\n                <p>Temperature min: \").concat(d.list[i].main.temp_min, \"</p>\\n                <p>Feels like: \").concat(d.list[i].main.feels_like, \"</p>\\n                <p>Wind direction: \").concat(degToCard(d.list[i].wind.deg), \"</p>\\n        </div>        \\n    </div>\\n\");\n  }\n};\n\n\n\n//# sourceURL=webpack:///./HourlyCard.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ WeatherCard; }\n/* harmony export */ });\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar WeatherCard = function WeatherCard(parrent, data, weatherArr, Stand) {\n  _classCallCheck(this, WeatherCard);\n\n  var sunrise = new Date((data.sys.sunrise - data.timezone) * 1000);\n  var sunset = new Date((data.sys.sunset - data.timezone) * 1000);\n  var src = weatherArr[data.weather[0].description.toLowerCase()] || Stand;\n  var dayL = (data.sys.sunset - data.timezone) * 1000 - (data.sys.sunrise - data.timezone) * 1000;\n  var dayLong = new Date(dayL);\n  var todayDate = new Date();\n  var month = (todayDate.getMonth() + 1).toString().length < 2 ? '0' + (todayDate.getMonth() + 1).toString() : (todayDate.getMonth() + 1).toString();\n  parrent.innerHTML += \"\\n    <div class=\\\"card bigDig blue lighten-2\\\">\\n        <div class=\\\"card-image\\\">\\n          <img src=\\\"\".concat(src !== undefined ? src : Stand, \"\\\">\\n        </div>\\n        <div class=\\\"\\\"call>\\n        <div class=\\\"card-content\\\">\\n            <span class=\\\"card-title\\\">Today is \").concat(todayDate.getDate(), \".\").concat(month, \".\").concat(todayDate.getFullYear(), \" </span>\\n            <h5>City: \").concat(data.name, \"</h5>\\n            <img src=\\\"http://openweathermap.org/img/wn/\").concat(data.weather[0].icon, \"@2x.png\\\" class = \\\"icon\\\"></img>\\n            <p>\").concat(data.weather[0].description[0].toUpperCase() + data.weather[0].description.substring(1), \"</p>\\n            <p>Temperature: \").concat(data.main.temp, \"</p>\\n            <p>Feels like: \").concat(data.main.feels_like, \"</p>\\n            <p>Sunrise: \").concat(sunrise.getHours(), \":\").concat(sunrise.getMinutes(), \"</p>\\n            <p>Sunset: \").concat(sunset.getHours(), \":\").concat(sunset.getMinutes(), \"</p>\\n            <p>Length of the day: \").concat(dayLong.getHours(), \":\").concat(dayLong.getMinutes(), \"</p>\\n        </div>\\n        <div/>\\n      </div>\\n\");\n};\n\n\n\n//# sourceURL=webpack:///./WeatherCard.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _img_stand_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./img/stand.jpg */ \"./img/stand.jpg\");\n/* harmony import */ var _DailyWeatherCard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DailyWeatherCard */ \"./DailyWeatherCard.js\");\n/* harmony import */ var _WeatherCard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./WeatherCard */ \"./WeatherCard.js\");\n/* harmony import */ var _HourlyCard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./HourlyCard */ \"./HourlyCard.js\");\n/* harmony import */ var _CityCard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./CityCard */ \"./CityCard.js\");\n/* harmony import */ var _img_broken_clouds_jpg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./img/broken_clouds.jpg */ \"./img/broken_clouds.jpg\");\n/* harmony import */ var _img_clear_sky_jpg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./img/clear_sky.jpg */ \"./img/clear_sky.jpg\");\n/* harmony import */ var _img_fog_jpg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./img/fog.jpg */ \"./img/fog.jpg\");\n/* harmony import */ var _img_light_rain_jpg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./img/light_rain.jpg */ \"./img/light_rain.jpg\");\n/* harmony import */ var _img_moderate_rain_jpeg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../img/moderate_rain.jpeg */ \"./img/moderate_rain.jpeg\");\n/* harmony import */ var _img_overcast_clouds_jpg__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./img/overcast_clouds.jpg */ \"./img/overcast_clouds.jpg\");\n/* harmony import */ var _img_scattered_clouds_jpg__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./img/scattered_clouds.jpg */ \"./img/scattered_clouds.jpg\");\n/* harmony import */ var _img_snow_jpg__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./img/snow.jpg */ \"./img/snow.jpg\");\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./styles/style.css */ \"./styles/style.css\");\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _iterableToArray(iter) { if (typeof Symbol !== \"undefined\" && iter[Symbol.iterator] != null || iter[\"@@iterator\"] != null) return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar navButton = document.querySelector(\"ul\").querySelectorAll('a');\nvar section = document.querySelectorAll('.section');\nnavButton.forEach(function (e, i) {\n  e.addEventListener(\"click\", function () {\n    section.forEach(function (l) {\n      l.style.display = \"none\";\n    });\n    section[i].style.display = \"flex\";\n  });\n});\nvar weatherArr = {\n  'scattered clouds': _img_scattered_clouds_jpg__WEBPACK_IMPORTED_MODULE_11__.default,\n  'light rain': _img_light_rain_jpg__WEBPACK_IMPORTED_MODULE_8__.default,\n  'moderate rain': _img_moderate_rain_jpeg__WEBPACK_IMPORTED_MODULE_9__.default,\n  'clear sky': _img_clear_sky_jpg__WEBPACK_IMPORTED_MODULE_6__.default,\n  'snow': _img_snow_jpg__WEBPACK_IMPORTED_MODULE_12__.default,\n  'mist': _img_fog_jpg__WEBPACK_IMPORTED_MODULE_7__.default,\n  'overcast clouds': _img_overcast_clouds_jpg__WEBPACK_IMPORTED_MODULE_10__.default,\n  'broken clouds': _img_broken_clouds_jpg__WEBPACK_IMPORTED_MODULE_5__.default\n};\nvar btn = document.querySelector('.getWeather');\nvar inp = document.querySelector('input');\nvar today = document.querySelector('#now');\nvar horlyNow = document.querySelector('#hourlyNow');\nvar sevDays = document.querySelector('#sevDays');\nsection[0].style.display = 'flex';\n\nfunction degToCard(value) {\n  value = parseFloat(value);\n  if (value <= 11.25) return 'N';\n  value -= 11.25;\n  var allDirections = ['NNE', 'NE', 'ENE', 'E', 'ESE', 'SE', 'SSE', 'S', 'SSW', 'SW', 'WSW', 'W', 'WNW', 'NW', 'NNW', 'N'];\n  var dIndex = parseInt(value / 22.5);\n  return allDirections[dIndex] ? allDirections[dIndex] : 'N';\n}\n\nvar options = {\n  enableHighAccuracy: true,\n  timeout: 5000,\n  maximumAge: 0\n};\n\nfunction success(pos) {\n  var crd = pos.coords;\n  console.log('Ваше текущее местоположение:');\n  console.log(\"\\u0428\\u0438\\u0440\\u043E\\u0442\\u0430: \".concat(crd.latitude));\n  console.log(\"\\u0414\\u043E\\u043B\\u0433\\u043E\\u0442\\u0430: \".concat(crd.longitude));\n  console.log(\"\\u041F\\u043B\\u044E\\u0441-\\u043C\\u0438\\u043D\\u0443\\u0441 \".concat(crd.accuracy, \" \\u043C\\u0435\\u0442\\u0440\\u043E\\u0432.\"));\n  var fixedLat = crd.latitude >= 0 ? \"+\".concat(crd.latitude) : crd.latitude;\n  var fixedLon = crd.longitude >= 0 ? \"+\".concat(crd.longitude) : crd.longitude;\n  fetch(\"https://wft-geo-db.p.rapidapi.com/v1/geo/locations/\".concat(fixedLat).concat(fixedLon, \"/nearbyCities?radius=100\"), {\n    \"method\": \"GET\",\n    \"headers\": {\n      \"x-rapidapi-key\": \"2ecc6a18f1msh149a8c93469a116p1ff3e3jsn92ea038f0326\",\n      \"x-rapidapi-host\": \"wft-geo-db.p.rapidapi.com\"\n    }\n  }).then(function (response) {\n    return response.json();\n  }).then(function (data) {\n    console.log(data);\n    inp.value = data.data[0].city;\n    btn.click();\n  }).catch(function (err) {\n    console.error(err);\n  });\n}\n\n;\n\nfunction error(err) {\n  console.warn(\"ERROR(\".concat(err.code, \"): \").concat(err.message));\n}\n\n;\nnavigator.geolocation.getCurrentPosition(success, error, options);\nbtn.addEventListener('click', function () {\n  otherCities.innerHTML = '';\n  fetch(\"https://api.openweathermap.org/data/2.5/weather?q=\".concat(inp.value, \"&units=metric&appid=d252a812218572d49d4bc5ad0a4df521\")).then(function (response) {\n    return response.json();\n  }).then(function (data) {\n    _toConsumableArray(today.children).forEach(function (e) {\n      return today.removeChild(e);\n    });\n\n    new _WeatherCard__WEBPACK_IMPORTED_MODULE_2__.default(today, data, weatherArr, _img_stand_jpg__WEBPACK_IMPORTED_MODULE_0__.default);\n    fetch(\"http://api.openweathermap.org/data/2.5/forecast?q=\".concat(inp.value, \"&units=metric&appid=d252a812218572d49d4bc5ad0a4df521\")).then(function (resp) {\n      return resp.json();\n    }).then(function (d) {\n      new _HourlyCard__WEBPACK_IMPORTED_MODULE_3__.default(horlyNow, d, weatherArr);\n      console.log(d);\n    });\n    fetch(\"https://api.openweathermap.org/data/2.5/onecall?lat=\".concat(data.coord.lat, \"&lon=\").concat(data.coord.lon, \"&units=metric&appid=d252a812218572d49d4bc5ad0a4df521\")).then(function (resps) {\n      return resps.json();\n    }).then(function (dat) {\n      console.log(dat);\n\n      _toConsumableArray(sevDays.children).forEach(function (e) {\n        return sevDays.removeChild(e);\n      });\n\n      new _DailyWeatherCard__WEBPACK_IMPORTED_MODULE_1__.default(sevDays, dat, weatherArr);\n    });\n    console.log(data.coord.lat, data.coord.lon);\n    var fixedLat = data.coord.lat >= 0 ? \"+\".concat(data.coord.lat) : data.coord.lat;\n    var fixedLon = data.coord.lon >= 0 ? \"+\".concat(data.coord.lon) : data.coord.lon;\n    fetch(\"https://wft-geo-db.p.rapidapi.com/v1/geo/locations/\".concat(fixedLat).concat(fixedLon, \"/nearbyCities?radius=100\"), {\n      \"method\": \"GET\",\n      \"headers\": {\n        \"x-rapidapi-key\": \"2ecc6a18f1msh149a8c93469a116p1ff3e3jsn92ea038f0326\",\n        \"x-rapidapi-host\": \"wft-geo-db.p.rapidapi.com\"\n      }\n    }).then(function (response) {\n      return response.json();\n    }).then(function (places) {\n      places.data.forEach(function (el) {\n        fetch(\"https://api.openweathermap.org/data/2.5/onecall?lat=\".concat(el.latitude, \"&lon=\").concat(el.longitude, \"&units=metric&appid=d252a812218572d49d4bc5ad0a4df521\")).then(function (resps) {\n          return resps.json();\n        }).then(function (nearWeather) {\n          return [console.log(nearWeather, '--'), new _CityCard__WEBPACK_IMPORTED_MODULE_4__.default(otherCities, nearWeather.daily[0], el)];\n        });\n      });\n      console.log(places);\n    }).catch(function (err) {\n      console.error(err);\n    });\n    console.log(data);\n  }).catch(function (err) {\n    console.error(err);\n  });\n});\n\n//# sourceURL=webpack:///./index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"6e1d45b824919066022d646d16a5da42.jpg\");\n\n//# sourceURL=webpack:///./img/broken_clouds.jpg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"83222b453e1fe9f0e10822faa998526c.jpg\");\n\n//# sourceURL=webpack:///./img/clear_sky.jpg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"c9bc8641e71ae17e7bb43a44d374ffe3.jpg\");\n\n//# sourceURL=webpack:///./img/fog.jpg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"1d47d8831c534fc38500737bc06d9c0e.jpg\");\n\n//# sourceURL=webpack:///./img/light_rain.jpg?");

/***/ }),

/***/ "./img/moderate_rain.jpeg":
/*!********************************!*\
  !*** ./img/moderate_rain.jpeg ***!
  \********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"cce7cfbc2f2d57a083c1dbab6e3ac616.jpeg\");\n\n//# sourceURL=webpack:///./img/moderate_rain.jpeg?");

/***/ }),

/***/ "./img/overcast_clouds.jpg":
/*!*********************************!*\
  !*** ./img/overcast_clouds.jpg ***!
  \*********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"04b35aa084fa550fd52adf1a7df70860.jpg\");\n\n//# sourceURL=webpack:///./img/overcast_clouds.jpg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"df7f7a956d6478651ead2eaf30dd194d.jpg\");\n\n//# sourceURL=webpack:///./img/scattered_clouds.jpg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"4eba2dabe93a2888d8858571224d29ce.jpg\");\n\n//# sourceURL=webpack:///./img/snow.jpg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"456e0cac695d44e76fae0d6623fb2c49.jpg\");\n\n//# sourceURL=webpack:///./img/stand.jpg?");
